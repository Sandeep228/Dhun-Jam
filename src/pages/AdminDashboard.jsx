...
function AdminDashboard() {
  ...
  const chartSetting = {
    ...
    sx: {
      stroke: 'white', // Change the color of axis lines
      [`.${axisClasses.left} .${axisClasses.axis}`]: {
        stroke: '#fff', // Change the color of y-axis line
      },
      [`.${axisClasses.bottom} .${axisClasses.axis}`]: {
        stroke: '#fff', // Change the color of x-axis line
      },
    },
  };
